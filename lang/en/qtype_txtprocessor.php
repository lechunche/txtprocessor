...
/**
 * Strings for component 'qtype_TextProcessor', language 'en', branch 'MOODLE_20_STABLE'
 *
 * @package    qtype
 * @subpackage TextProcessor
...
$string['pluginname'] = 'Text Processor';
...
$string['pluginnameadding'] = 'Adding a text processor question';
$string['pluginnameediting'] = 'Editing a text processor question';
...
$string['prellenado'] = 'Prefilled answer';
$string['tituloPrellenado'] = 'Area to prefill the answer';
//$string['pluginnamesummary'] = 'Allows a response of one or a few words that is graded by comparing against various model answers, which may contain wildcards.';