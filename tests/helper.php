...
/**
 * Test helpers for the shortanswer_1 question type.
 *
 * @package    qtype_shortanswer_1
...
/**
 * Test helper class for the shortanswer_1 question type.
 *
 * @copyright  2011 The Open University
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_shortanswer_1_test_helper extends question_test_helper {
    public function get_test_questions() {
        return array('frogtoad', 'frogonly', 'escapedwildcards');
    }

    /**
     * Makes a shortanswer_1 question with correct ansewer 'frog', partially
     * correct answer 'toad' and defaultmark 1. This question also has a
     * '*' match anything answer.
     * @return qtype_shortanswer_1_question
     */
    public function make_shortanswer_1_question_frogtoad() {
        question_bank::load_question_definition_classes('shortanswer_1');
        $sa = new qtype_shortanswer_1_question();
        ...
        $sa->qtype = question_bank::get_qtype('shortanswer_1');

        return $sa;
    }

    /**
     * Gets the question data for a shortanswer_1 question with with correct
     * ansewer 'frog', partially correct answer 'toad' and defaultmark 1.
     * This question also has a '*' match anything answer.
     * @return stdClass
     */
    public function get_shortanswer_1_question_data_frogtoad() {
        $qdata = new stdClass();
        test_question_maker::initialise_question_data($qdata);

        $qdata->qtype = 'shortanswer_1';
    ...
    /**
     * Makes a shortanswer_1 question with just the correct ansewer 'frog', and
     * no other answer matching.
     * @return qtype_shortanswer_1_question
     */
    public function make_shortanswer_1_question_frogonly() {
        question_bank::load_question_definition_classes('shortanswer_1');
        $sa = new qtype_shortanswer_1_question();
        test_question_maker::initialise_a_question($sa);
        $sa->name = 'Short answer question';
    ...
    /**
     * Gets the question data for a shortanswer_1 questionwith just the correct
     * ansewer 'frog', and no other answer matching.
     * @return stdClass
     */
    public function get_shortanswer_1_question_data_frogonly() {
        $qdata = new stdClass();
        test_question_maker::initialise_question_data($qdata);
     ...
     * @return qtype_shortanswer_1_question
     */
    public function make_shortanswer_1_question_escapedwildcards() {
        question_bank::load_question_definition_classes('shortanswer_1');
        $sa = new qtype_shortanswer_1_question();
        test_question_maker::initialise_a_question($sa);
